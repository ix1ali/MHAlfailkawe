...
export default function LoginPage() {
  const { login, user, loading, notice, clearNotice } = useAuth();
  const { data } = useStore();
  ...
  return (
    <div className="relative grid min-h-dvh place-items-center overflow-hidden bg-[var(--bg)] px-4 py-8">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div className="absolute -right-24 -top-28 h-80 w-80 rounded-full bg-[radial-gradient(circle,rgba(26,86,219,.20),transparent_65%)]" />
