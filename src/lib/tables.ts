/**
 * وصف جداول قاعدة البيانات وتحويل صفوفها من وإلى نموذج بيانات الواجهة.
 * مشترك بين الخادم والمتصفح — لا يعتمد على أي منهما.
 */
import type {
...
export const DEFAULT_SETTINGS: AppData["settings"] = {
  orgName: "إدارة عقار محمود الفيلكاوي",
  ownerFullName: "محمود محمود عبدالمجيد الفيلكاوي",
  currency: "KWD",
 ...
 * وتحويل الصف في الاتجاهين. هذا هو كل ما يربط النظام بقاعدة البيانات.
 */
...
const users: Coll<"users"> = {
  key: "users", table: "users", order: { col: "created_at", asc: true },
  fromRow: (r): User => ({
...
export const settingsToRow = (x: AppData["settings"]) => ({
  id: 1,
...
export const settingsFromRow = (r: Row): AppData["settings"] => ({
